...
hori_check_matrix, hori_parity_rows_to_faces = f.generate_check_matrix_from_faces(
    hori_stab_faces_rect
)  # TODO make a special +y/x for check mats

# %%
hori_matching_graph = f.ret2net(
    f.generate_error_syndrome_graph(hori_check_matrix, f.no_bits)
)
